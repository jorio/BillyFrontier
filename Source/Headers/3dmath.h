...
float	p1x,p1y,p1z;
	...
	OGLVector3D_Normalize(&plane->normal, &plane->normal);
...
float	dot;
	...
	dot = ((v1->x * v2->x) + (v1->y * v2->y) + (v1->z * v2->z));		// calc dot
			...
			//
			// BE CAREFUL!  SOME A-TYPICAL CALCULATIONS WANT WEIRD DOT VALUES SO THIS
			// FUNCTION COULD SERIOUSLY SCREW THEM UP SINCE IT PINS THE VALUES.
			// FOR EXAMPLE, THERE ARE DOT FUNCTIONS IN PICK.C WHICH NEED FUNKY VALUES.
			//
